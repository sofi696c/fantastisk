    ...
    <nav class="container">
      <div class="porfolie">
        <div class="logo">
          ...
          <h1 class="logo">Fantasy Quest</h1>
        </div>
      </div>

      <ul class="nav-routes">
        <li><a href="https://fantasyfestival.dk/" target="_blank">Gå til Fantasyfestivalens hjemmeside</a></li>          
...
header {
  ...
  height: 10vh;
  transition: 0.3s; /* Add smooth transition for sticky effect */
}
